namespace WeatherForecasts.API.Middlewares
{
    public class RequestResponseLoggerMiddleware
    {
        ...
        private static string FormatHeaders(IHeaderDictionary headers) => string.Join(", ", headers.Select(kvp => $"{{{kvp.Key}: {string.Join(", ", kvp.Value.ToArray())}}}"));
